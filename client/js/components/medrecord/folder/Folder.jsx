...
class Folder extends Component {
  ...
  componentDidMount() {
    medrecService.getAttachments(this.props.params.id, this.props.location.state.mrId, (err, attachs) => {
      if (err) {
        this.setState({
      ...
      <div className="content-wrapper">
            ...
            <h3>Attachments</h3>
              <hr/>
               ...
               {
                 attachs && attachs.length > 0 &&
                 <AttachmentsTable attachs={attachs} onError={this.handleError} showMedrecs={false}/>
               }
        </div>
      );
  }
